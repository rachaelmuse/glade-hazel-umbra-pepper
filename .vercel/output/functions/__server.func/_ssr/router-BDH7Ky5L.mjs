...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BDH7Ky5L.js
var router_BDH7Ky5L_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-CzF-ay90.css";
var APP_NAME = "Homecoming Signal";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "321 kHz homecoming carrier and Schumann cavity modes. The file holds the tone. The scope shows the envelope."
			},
			{
				name: "theme-color",
				content: "#0b0d11"
...
var $$splitComponentImporter$1 = () => import("./routes-BadHToOt.mjs");
...
//#endregion
export { getRouter, router_BDH7Ky5L_exports as t };
